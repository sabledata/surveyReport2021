...
\subsubsection{STRATIFIED RANDOM SAMPLING SURVEY COMPONENT}\label{section2.1.1}}
...
A biological sample was collected from the coded ``A'' traps with the goal of selecting 50 to 60 fish. If CPUE was high, the new survey protocol of 2018 designated a minimal of two traps to be used for samples. If both traps contained more than 60 Sablefish, a random process was used to select \textasciitilde60 specimens. If catch rates were low, traps with ``D' designation would switched to `A' to ensure the biosample could meet the goal of 50-60 fish.
