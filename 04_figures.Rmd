...
```{r figureSetUp, echo=FALSE, out.width = "400px",  fig.align = "center", warning=FALSE}

    #   results='asis',echo=FALSE,include=FALSE,warning=FALSE,message = FALSE,error= FALSE
    #   png(paste(basepath,'figures/figure7.png',sep=''), width = 575, height = 784)  # write png to folder 
    #   png(paste(basepath,'figures/figure7.png',sep=''))  # write png to folder 
...
```{r figure8, fig.cap='(ref:figure8)', out.width = "450px", out.height = "576px",echo=FALSE, fig.align="center", warning=FALSE}
    ...
    ggplot(tgcnt, aes(x=SET_YEAR,y=sable_cnt,label = round(sable_cnt,1))) +   # add label just for temporary visual
